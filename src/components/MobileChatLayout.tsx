...
import FriendsRequestSideBarOptions from './FriendsRequestSideBarOptions'
import SignOutLayout from './ui/SignOutLayout'
  ...
  return (
    <div className='fixed bg-zinc-50 border-b border-zinc-200 top-0 inset-x-0 py-2 px-4'>
      <div className='w-full flex justify-between items-center'>
        ...
        <ButtonVariants onClick={() => setOpen(true)} className='gap-4'>
                        ...
                        <nav className='flex flex-1 flex-col'>
                          <ul
                            ...
                            <li className='-ml-6 mt-auto flex items-center'>
                              ...
                              <div className='h-full aspect-square mr-11' >
                              <SignOutLayout />
                              </div>
                            </li>
                          </ul>
